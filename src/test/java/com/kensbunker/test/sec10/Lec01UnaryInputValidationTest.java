...
import com.kensbunker.models.sec10.AccountBalance;
import com.kensbunker.models.sec10.BalanceCheckRequest;
...
public class Lec01UnaryInputValidationTest extends AbstractTest {
  ...
  public void asyncInputValidationTest() {
    ...
    Assertions.assertEquals(
        ValidationCode.INVALID_ACCOUNT, getValidationCode(observer.getThrowable()));
  }
}
